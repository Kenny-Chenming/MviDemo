...
sealed class BottomNavRoute(
    ...
    data object PlayBillingMigration : BottomNavRoute(route = "play_billing_migration", title = "PBL9迁移", icon = Icons.Default.Policy)
}
...
object NavRoutes {
    ...
    // PRD-S: Google Play Billing Library 9 企业级迁移工具包
    const val PLAY_BILLING_MIGRATION = "play_billing_migration"
}
