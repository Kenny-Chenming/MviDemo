...
sealed interface OtterMcpIntent { data class NavigateTo(val screen: SubScreen) : OtterMcpIntent; data object LoadDashboard : OtterMcpIntent; data object RefreshConnections : OtterMcpIntent; data class ConnectionWizardIntent(val intent: ConnectionWizardIntent) : OtterMcpIntent; data class TemplateGalleryIntent(val intent: TemplateGalleryIntent) : OtterMcpIntent; data class SecurityIntent(val intent: SecurityIntent) : OtterMcpIntent; data class AuditLogIntent(val intent: AuditLogIntent) : OtterMcpIntent; data class DeviceInteractionIntent(val intent: DeviceInteractionIntent) : OtterMcpIntent; data class DashboardIntent(val intent: DashboardIntent) : OtterMcpIntent }
